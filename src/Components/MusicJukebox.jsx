  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative flex justify-center mb-5">
        <input
          type="text"
          className="border-2 border-gray-300 p-2 w-full max-w-xl rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          placeholder="Search a song"
          value={searchTerm}
          onChange={handleSearchChange}
        />
        {suggestions.length > 0 && (
          <ul className="absolute top-full mt-1 w-full max-w-xl bg-white border border-gray-300 rounded-md shadow-md z-10">
            {suggestions.map((video, idx) => (
              <li
                key={idx}
      ...
      <div className="aspect-w-16 aspect-h-9 mb-5">
        <div id="yt-player" className="w-full h-full rounded-lg shadow-lg"></div>
      </div>
      ...
      <div className="queue-section">
        ...
        <ul className="space-y-2">
          {queue.slice(1).map((video, idx) => (
            <li
              key={idx}
              className="flex justify-between items-center bg-gray-100 p-3 rounded-md shadow-sm text-sm sm:text-base"
            >
