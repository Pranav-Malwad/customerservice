...
export default function ComplimentBox() {
  ...
  return (
    <div className=" mt-20 px-4 sm:px-6 lg:px-8 max-w-md mx-auto p-6 rounded-2xl bg-gradient-to-br from-[#f0fdf4] to-[#d1fae5] shadow-xl text-center animate-fade-in">
